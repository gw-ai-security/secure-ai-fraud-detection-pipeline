...
## 1. Purpose
The first phase of this project lays the regulatory, business, and technical foundation for a GDPR-, PSD2-, and AI Act-aligned fraud detection pipeline in the EU banking sector.
...
- `docs/gdpr_mapping_table.md`
- `docs/ai_act_ce_declaration_draft.md`
- Synthetic fraud dataset prototype (`notebooks/data/raw/fraud_simulated.csv`)
...
- Expand Privacy-by-Design techniques (data minimization, pseudonymization).
